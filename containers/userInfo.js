...
// 用户信息展示行高度
const USERINFOROWHEIGHT = 90;

// 用户信息展示项目 icon 宽高
const USERINFOITEMICONSIZE = 24;

const styles = StyleSheet.create( {
	container: { marginTop: 6, backgroundColor: "#FFFFFF" },
...
export default React.memo( function UserInfo( { data, hasActivity } )
{
	return hasActivity
		? <View style = { styles.container }>
			...
			<View style = { styles.userInfoRow }>
				...
				<UserInfoItem title = { I18n.t( "finance.userInfo.allInvest" ) } value = { data[ "累计投资" ] } image = { require( "./../images/yesterday_earnings.png" ) } />
