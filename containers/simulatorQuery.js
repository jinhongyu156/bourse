...
export default React.memo( function Query( { data, loading, error, queryTypeIndex, isShowActionSheet, actionSheetData, showQueryTypeIndexActionSheet, hideActionSheet, fetchData } )
{
