...
export default function Draggable(props) {
  ...
  React.useEffect(() => {
	...
	const positionCss = React.useMemo( () => ( { position: "absolute", top: 0, left: 0, width: SCREENWIDTH, height: SCREENHEIGHT } ), []);
