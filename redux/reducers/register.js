...
const defaultState = {
	...
	fetchRegisterError: null					// 注册错误信息
};
...
export default function( state = defaultState, action )
{
	switch( action.type )
	{
		case ACTION_SET_REGISTER_ISLOADING:
		...
		case ACTION_SET_REGISTER_FETCHREGISTERERROR:
			return Object.assign( {}, state, { fetchRegisterError: action.payload } );
